...
file_path = "data/grand_targhee_snotel.csv"
...
results.to_csv("results/snowfall_predictions_xgb.csv", index=False)
...
# plt.yscale('log')
plt.tight_layout()
plt.savefig("figures/snowfall_histogram.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("figures/snowfall_prediction.png", dpi=300)
plt.show()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("figures/snowfall_prediction_full.png", dpi=300)
plt.show()
...
plt.savefig("figures/actual_vs_predicted_scatter.png", dpi=300) # save scatter plot 
plt.tight_layout()
plt.show()
...
plt.savefig("figures/confusion_matrix.png", dpi=300) # save confusion matrix
plt.show()
